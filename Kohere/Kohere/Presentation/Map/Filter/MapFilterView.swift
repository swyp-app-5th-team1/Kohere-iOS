...
struct MapFilterView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            KohereNavigationBar(
                ...
                center: .text(language.localized(.mapFilterTitle))
            )
    ...
    private var priceSection: some View {
        MapFilterSection(title: language.localized(.mapFilterSectionPrice)) {
            VStack(spacing: 16) {
                MapPriceRangeControl(
                    title: language.localized(.mapFilterMonthlyRent),
                ...
                MapPriceRangeControl(
                    title: language.localized(.mapFilterDeposit),
    ...
    private var propertyTypeSection: some View {
        MapFilterSection(title: language.localized(.mapFilterSectionPropertyType)) {
            MapFilterFlowLayout(spacing: 8, rowSpacing: 8) {
